...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            kz.project.Blog.models.entities.User creds = new ObjectMapper()
                    .readValue(req.getInputStream(), kz.project.Blog.models.entities.User.class);
            kz.project.Blog.models.entities.User user = userService.findByLogin(creds.getLogin());
