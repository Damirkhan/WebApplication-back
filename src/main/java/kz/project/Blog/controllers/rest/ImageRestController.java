...
public class ImageRestController extends MainController {
    private ImageRepository imageRepository;
    private UserService userService;
    @Autowired
    public  ImageRestController(ImageRepository imageRepository, UserService userService){
    ...
    public ResponseEntity<?> uplaodImage(@RequestParam("imageFile") MultipartFile file) throws IOException {
        ...
        return buildResponse(img, HttpStatus.OK);
    }
